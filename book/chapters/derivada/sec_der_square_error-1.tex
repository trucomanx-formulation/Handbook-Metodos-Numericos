...
\begin{corollary}[Derivada de $\MATRIX{A}\VECTOR{x}$ em relação ao vetor $\VECTOR{x}^{\transpose}$:]\label{coro:derAx1}
...
\begin{corollary}[Derivada de $\MATRIX{A}\VECTOR{x}$ em relação ao vetor $\VECTOR{x}$:]\label{coro:derAx2}
...
\newpage
\begin{corollary}[Derivada de $\VECTOR{a}^{\transpose}\VECTOR{x}$ em relação ao vetor $\VECTOR{x}^{\transpose}$:]\label{coro:derAx3}
...
\begin{corollary}[Derivada de $\VECTOR{a}^{\transpose}\VECTOR{x}$ em relação ao vetor $\VECTOR{x}$:]\label{coro:derAx4}
