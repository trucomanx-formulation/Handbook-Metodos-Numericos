...
\begin{corollary}[Derivada de $||\MATRIX{A}\VECTOR{x}||^2$ em relação ao vetor $\VECTOR{x}^{\transpose}$:]\label{coro:derxAtAx1}
...
\begin{corollary}[Derivada de $||\MATRIX{A}\VECTOR{x}||^2$ em relação ao vetor $\VECTOR{x}$:]\label{coro:derxAtAx2}
