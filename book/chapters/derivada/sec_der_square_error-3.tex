...
\begin{corollary}[Derivada de $||\MATRIX{A}\VECTOR{x}-\VECTOR{b}||_{\MATRIX{C}}^2$ em relação ao vector $\VECTOR{x}^{\transpose}$]\label{coro:derAxbAxb1}
...
\begin{corollary}[Derivada de $||\MATRIX{A}\VECTOR{x}-\VECTOR{b}||_{\MATRIX{C}}^2$ em relação ao vector $\VECTOR{x}$]\label{coro:derAxbAxb2}
