...
\begin{proposition}[Serie de Taylor de $f(x)$:]\label{prop:taylord}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\index{Serie de Taylor!$\VECTOR{f}:\mathbb{R} \rightarrow \mathbb{R}^{N}$}
\begin{proposition}[Serie de Taylor de $\VECTOR{f}(t)$:]\label{prop:taylorvecf}
