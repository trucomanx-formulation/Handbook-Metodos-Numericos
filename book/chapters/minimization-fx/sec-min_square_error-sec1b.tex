...
\end{equation}
Assim, o mínimo $\VECTOR{\hat{x}}$ existe e é único só sim $\MATRIX{A}^{\transpose}\MATRIX{C}\MATRIX{A} +\alpha\MATRIX{D}$ tem inversa.
\end{theorem}
...
Usando a Eq. (\ref{eq:minAxbCAxb2alphaxqD}) calculamos o ponto $\VECTOR{\hat{x}}=[0.85714\quad 0.85714]^{\transpose}$
