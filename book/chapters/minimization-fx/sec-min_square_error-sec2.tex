...
logo concluimos que a resposta é $\VECTOR{\hat{x}}\approx \VECTOR{x}_5 =[0.90856\quad 0.90856]^{\transpose}$
...
na qual assumimos o final do processo iterativo quando $\VECTOR{x}_k \approx \VECTOR{x}_{k-1}$.
