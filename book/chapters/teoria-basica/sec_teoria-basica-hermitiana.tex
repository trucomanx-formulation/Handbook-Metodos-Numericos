...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{theorem}[Matriz unitária e matrize hermitiana:]\label{theo:unitariahermitian0}
Dada uma matriz hermitiana $\MATRIX{A} \in \mathbb{C}^{N \times N}$.
\begin{itemize}
...
\end{theorem}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{theorem}[Propiedades das matrizes hermitianas definidas positivas:]\label{theo:prophermitianpositivematrix0}
Dada uma matriz hermitiana $\MATRIX{A} \in \mathbb{C}^{N \times N}$.
\begin{itemize}
%%%%%
...
$\MATRIX{R}$ é uma matriz não singular (invertível) \cite[pp. 309]{hartfiel2000matrix}. %\cite[pp. 420]{korn2013mathematical}.
\end{itemize}
\end{theorem}
