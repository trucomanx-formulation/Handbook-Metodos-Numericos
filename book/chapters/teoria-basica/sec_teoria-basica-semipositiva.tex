...
\begin{theorem}[Matriz  $\MATRIX{A}^{\transpose}\MATRIX{A}$ e matrizes semidefinidas positivas:]\label{theo:semipositivematrix1}
...
\begin{theorem}[Autovalores e matrizes semidefinidas positivas:]\label{theo:semipositivematrix2}
