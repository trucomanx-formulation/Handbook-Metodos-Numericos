...
figure(2)
mesh(U,V,W,'linewidth',LINEWIDTH)
hx=xlabel('y_1');
...
err=fune(xx1,xx2,B);
figure(3)
mesh(xx1,xx2,err,'linewidth',LINEWIDTH)
hold on
...
view([ 36.622, 13.491])
hold on
scatter3(P(1),P(2),fune(P(1),P(2),B),480,'MarkerFaceColor',[1 0 0],'filled','linewidth',LINEWIDTH)
hold off
set(gca,'fontsize',FONTSIZE)
%set(gca,'linewidth',LINEWIDTH)
