...
\input{chapters/minimization-hx/min_square_error_hx-proofs}


%----------------------------------------------------------------------------------------
%	PART
%----------------------------------------------------------------------------------------
\part{Aplicações: Achar raízes de funções}
% CHAPTER  
\include{chapters/roots/raiz_hx}
...
% CHAPTER  
\include{chapters/inverso-mapeamento/mapeamento}
