...
\documentclass[a4paper,12pt]{extbook} % Default font size and left-justified equations
...
\newcommand{\ImprimirLinkErroresLivro}[0]{\url{\ImprimirLinkGitHub/metodos.numericos/erros.html}}
...
\newcommand{\imprimirpapersize}[0]{21x30cm}%{\textcolor{red}{XXXxXXXcm}} %{21x30cm}
...
\newcommand{\imprimirisbn}[0]{978-65-00-07314-0}
...
%	PART
%----------------------------------------------------------------------------------------
\part{Minimização do erro e funções de custo}
% CHAPTER  
