...
%%% \definecolor{excolor}{RGB}{80,8,8} % Define the orange color used for highlighting throughout the book
%%% \newboxedtheorem[boxcolor=excolor, 
%%%                  background=excolor!15, 
%%%                  titlebackground=excolor!5,
%%%                  titleboxcolor = black]
%%%                  {bexample}{Exemplo}{thm}
